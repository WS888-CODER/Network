...
public class PlayingRoomFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Number Spyers In This Playing Room:");

        jLabel3.setFont(new java.awt.Font("Lucida Calligraphy", 3, 18)); // NOI18N
        jLabel3.setText("# Of Number Spyers In This Playing Room:");
        ...
        jTextArea2.setFont(new java.awt.Font("Traditional Arabic", 3, 14)); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PlayingRoomFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PlayingRoomFrame().setVisible(true);
            }
        });
    }
